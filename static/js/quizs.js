(function($) {
    $.fn.jquizzy = function(settings) {
        var defaults = {
            questions: null,
            startImg: 'static/images/start.gif',
            endText: '已结束!',
            shortURL: null,
            sendResultsURL: null,
            ques_num:0,
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">本次考试时间'+config.exam_time+'分钟，共'+config.ques_num+'道题目。<br>你准备好了吗？<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
        ...
        superContainer.find('.nav-start').click(function() {
            ...
            //开始倒计时
            var intDiff = parseInt(config.exam_time) * 60;//倒计时总秒数量
            exam_timer(intDiff);
            return false;
        });
        ...
        superContainer.find('.final').click(function() {
            ...
            if (config.sendResultsURL !== null) {
				...
				$.getJSON(config.sendResultsURL,{an:myanswers,exam_log_id:exam_log_id},function(json){
					if(json==null){
						alert('通讯失败！');
					}else{
